...
const CsrProjects = [
  {
    ...
    icon: <Droplets className={cn("h-10 w-10 text-secondary", "icon-glow-light dark:icon-glow-dark")} />,
  },
  {
    ...
    icon: <Recycle className={cn("h-10 w-10 text-secondary", "icon-glow-light dark:icon-glow-dark")} />,
  },
  {
    ...
    icon: <Leaf className={cn("h-10 w-10 text-secondary", "icon-glow-light dark:icon-glow-dark")} />,
  },
];
            ...
            {CsrProjects.map((project, index) => (
              <Card key={index} className="text-center">
                <CardContent className="p-8">
                  ...
                  <p className="mt-2 text-description-constant">{project.description}</p>
                </CardContent>
              </Card>
            ))}
          </div>
