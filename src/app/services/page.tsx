                ...
                <div className="mt-2 bg-card border rounded-lg p-2">
                    ...
                    {filteredServices.map((service) => (
                        ...
                        >
                            ...
                            {React.isValidElement(service.icon) ? React.cloneElement(service.icon as React.ReactElement<any>, { className: 'h-5 w-5 flex-shrink-0 icon-glow-light dark:icon-glow-dark' }) : null}
