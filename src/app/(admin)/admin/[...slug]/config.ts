...
export const tableConfig: Record<string, { 
  ...
  'job-applications': { db: 'main', table: 'job_applications', columns: ['id', 'firstName', 'lastName', 'email', 'jobTitle', 'timestamp'], dateColumn: 'timestamp', searchColumns: ['firstName', 'lastName', 'email', 'jobTitle'] },
  'ssp/orders': { 
      db: 'ssp', 
      table: 'ssp_orders', 
