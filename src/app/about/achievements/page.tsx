import { achievements } from '@/lib/data.tsx';
...
const getIconForType = (type: string) => {
    switch(type) {
        case 'Accreditation': return <CheckCheck className="h-6 w-6 text-green-500" />;
        case 'Award': return <Award className="h-6 w-6 text-amber-500" />;
        case 'Collaboration': return <Handshake className="h-6 w-6 text-blue-500" />;
        default: return null;
    }
}
