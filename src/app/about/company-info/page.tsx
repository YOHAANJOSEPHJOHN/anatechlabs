                ...
                <div>
                    <div className="relative mb-8">
                        <div className="flex items-start gap-4">
                            <div className="bg-secondary/10 p-3 rounded-lg mt-1"><Rocket className="h-6 w-6 text-secondary" /></div>
                            <div>
                    ...
                    <div className="relative">
                        <div className="flex items-start gap-4">
                            <div className="bg-secondary/10 p-3 rounded-lg mt-1"><HeartPulse className="h-6 w-6 text-secondary" /></div>
                            <div>
