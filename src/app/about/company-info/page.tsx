                    ...
                    <div className="relative mb-8">
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p className="mt-2 text-lg text-description-constant">To deliver exceptional scientific services that protect public health, ensure environmental sustainability, and support our clients' success through data-driven insights and unwavering expertise.</p>
                            </div>
                        </div>
                    </div>
                    <div className="relative">
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p className="mt-2 text-lg text-description-constant">To be the most trusted partner and a global leader in creating a safe and sustainable future, recognized for our scientific innovation, integrity, and commitment to a healthier planet.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, index) => (
                <Card key={index}>
                    ...
                    <CardContent>
                        <p className="text-description-constant">{value.description}</p>
                    </CardContent>
                </Card>
            ))}
        </div>
