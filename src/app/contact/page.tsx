...
const contactInfo = [
  { icon: <Phone className="h-5 w-5 text-secondary" />, text: '9844163329', href: 'tel:9844163329' },
  { icon: <Mail className="h-5 w-5 text-secondary" />, text: 'contact@anatech.com', href: 'mailto:contact@anatech.com' },
  { icon: <MapPin className="h-5 w-5 text-secondary" />, text: '16, 18th A Cross Rd, 1st main, Bhuvaneswari Nagar, Hebbal Kempapura, Bengaluru, Byatarayanapura CMC and OG Part, Karnataka 560024' },
];
                        ...
                        <FormItem>
                          ...
                          <Select onValueChange={field.onChange} defaultValue={field.value}>
                            ...
                            <SelectContent>
                              ...
                              <SelectItem value="ems">EMS Inquiry</SelectItem>
          ...
          <div className="lg:col-span-5 space-y-8">
            ...
            <Card>
                <div className="aspect-video w-full bg-muted rounded-lg overflow-hidden">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3886.7188814904025!2d77.6028031745479!3d13.053557513077205!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae17e73522942f%3A0x77edc5d26981a6d3!2sAnatech%20Lab%20%26%20Research%20Centre!5e0!3m2!1sen!2sin!4v1762840035099!5m2!1sen!2sin"
                        width="100%"
                        height="100%"
                        style={{ border: 0 }}
