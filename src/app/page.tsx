...
export default function Home() {
  ...
  const highlights = [
    ...
    {
      icon: <TestTubes className="h-10 w-10 text-secondary icon-glow-light dark:icon-glow-dark" />,
                  ...
                  <div className="relative h-[60vh] md:h-[80vh] w-full overflow-hidden">
                    ...
                    >
                      <h1 
                        ...
                        style={{ textShadow: '0 2px 10px rgba(0,0,0,0.25)', lineHeight: 1.1, letterSpacing: '-0.5px' }}
                      >
                        {slide.title}
                      </h1>
                      <p 
                        className="mt-4 max-w-2xl text-lg md:text-xl text-black"
              ...
              <div className="mt-6 space-y-4">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground/80">To deliver globally benchmarked Occupational Health & Safety and environmental testing services through accredited methodologies, advanced instrumentation and uncompromising quality systems — providing reliable data, actionable insights and end-to-end compliance support that help our clients safeguard workplaces, strengthen performance and build a safer, cleaner future.</p>
                  </div>
                </div>
                 <div className="flex items-start gap-4">
                  ...
                  <CardHeader>
                    <div className="flex items-start gap-4">
                      <div className="bg-secondary/10 p-3 rounded-full">
                         <ServiceIcon iconName={service.icon} className="h-8 w-8 text-secondary icon-glow-light dark:icon-glow-dark" />
                      </div>
       ...
       <section className="section-padding relative bg-cover bg-center">
        ...
        <div className="container mx-auto relative z-[2]">
           <div className="text-center" style={{ textShadow: '0 2px 18px rgba(0,0,0,0.45)' }}>
                ...
                <p className="mt-2 max-w-2xl mx-auto text-lg text-foreground/80 dark:text-white/80">Empowering professionals through specialized laboratory, safety, and environmental skill-building programs.</p>
            </div>
