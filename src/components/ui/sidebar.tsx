  ...
  (
    ...
    if (collapsible === "none") {
      return (
        <div
          className={cn(
            "flex h-screen flex-col bg-sidebar text-sidebar-foreground w-[var(--sidebar-width)] border-r",
            className
          )}
          ref={ref}
          {...props}
    ...
    return (
      <div
        ref={ref}
        className={cn(
            "group hidden md:flex flex-col h-screen bg-sidebar text-sidebar-foreground border-r",
    ...
    const button = (
        <Comp
            ...
            className={cn(
                ...
                "group-data-[state=collapsed]:w-8 group-data-[state=collapsed]:justify-center group-data-[state=collapsed]:px-0",
                className
            )}
            {...props}
        >
