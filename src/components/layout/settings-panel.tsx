  ...
  return (
    <div className="rounded-lg border p-3">
      <div className="flex items-start gap-3">
        <div className="mt-1">
          <BellIcon className="h-5 w-5 text-foreground transition-transform group-hover:animate-bounce" />
        </div>
        <div className="flex-1">
          ...
          <div className="mt-4 space-y-3 pr-2">
            <div className="flex items-center justify-between">
              <Label htmlFor="workshop-updates" className="text-sm font-normal">Workshop Updates</Label>
              <Switch
                id="workshop-updates"
            ...
            <div className="flex items-center justify-between">
              <Label htmlFor="csr-announcements" className="text-sm font-normal">CSR Announcements</Label>
              <Switch
            ...
            <div className="flex items-center justify-between">
              <Label htmlFor="newsletter" className="text-sm font-normal">Blog/Newsletter</Label>
              <Switch
                id="newsletter"
    ...
    <Dialog>
      <DialogTrigger asChild>
        <button className={cn(
          ...
          <div className="flex items-start gap-3">
            <div className="mt-1">
                <ShieldIcon className="h-5 w-5 text-foreground" />
            </div>
            <div className="flex-1">
