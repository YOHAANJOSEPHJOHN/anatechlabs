                  ...
                  {currentStep === STEPS.CUSTOMER_DETAILS && (
                      <motion.div key="step1" initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: 20 }}>
                          <Card style={{ borderRadius: '15px' }} className="shadow-lg">
                              ...
                              <CardContent>
                                  <div
                                      className="mb-6 flex items-start gap-4 rounded-lg border border-destructive/30 bg-destructive/10 p-4 text-sm text-destructive-foreground/90"
                                      style={{
                                  ...
                                  >
                                      <AlertTriangle className="h-5 w-5 flex-shrink-0 text-destructive/80" />
                                      <div>
                                          <p className="font-semibold">Warning: We are currently not taking any Orders.</p>
                                          <p className="mt-1 text-xs">Kindly visit our branch, contact us at 9844163329, or click/scan the QR code at the bottom of the website for more information.</p>
                                      </div>
                                  </div>
