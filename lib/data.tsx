...
export const heroSlides = [
    {
        title: "Comprehensive Occupational & Environmental Analytical Labs",
        description: "Precision testing delivering integrated OHS and EHS testing for regulatory compliance, exposure assessment, and Product Testing and Certifications.",
    ...
    {
        title: "Food safety Testing - Nutrition, Adulterant & Contaminant Profiling",
        description: "Targeted chemistries to detect adulterants, contaminants, and impurity profiles in packed, processed, and pre‑processed food products, ensuring label integrity, safety, and regulatory compliance.",
        alt: "Microbiologist examining petri dishes",
        imageId: "hero-5"
    },
    {
        title: "Product Testing, Certification & Safety Assurance",
        description: "End‑to‑end physico‑chemical, microbiological, and safety testing across product categories to validate quality, verify claims, and support national and international certification requirements.",
...
export const services: Service[] = [
  // OHS
  {
    ...
    cataloguePdf: 'https://drive.google.com/file/d/1G0ahwHnlnRQIEKWPvhURNCFjWCtd2UPc/view?usp=sharing',
    elementsPdf: '#',
  },
  {
    id: 'ohs-2',
    ...
    cataloguePdf: 'https://drive.google.com/file/d/1PT9-KR4IRy4pJ4LZKhLl0mwjEOs-lUEm/view?usp=sharing',
    elementsPdf: '#',
  },
  {
    id: 'ohs-3',
    ...
    cataloguePdf: 'https://drive.google.com/file/d/1zI1lLL_kPvnAJ0JGVV2kbag27HEVzvfl/view?usp=sharing',
    elementsPdf: '#',
  },
  {
    id: 'ohs-4',
    ...
    cataloguePdf: 'https://drive.google.com/file/d/1hXuQrEOU30NqVt2wEtbY5GNPCGwN9IvL/view?usp=sharing',
    elementsPdf: '#',
  },
  {
    id: 'ohs-5',
    ...
    cataloguePdf: 'https://drive.google.com/file/d/1r1R9hje2O7u9WRSpvNw-N_ElSlee75NP/view?usp=sharing',
    elementsPdf: '#',
  },
   {
    id: 'ohs-6',
    ...
    cataloguePdf: 'https://drive.google.com/file/d/13S-Qcn0jXYFpeEb6Rpvt5_yZi0bxt6iz/view?usp=sharing',
    elementsPdf: '#',
  },
  // EHS
  {
    ...
    cataloguePdf: 'https://drive.google.com/file/d/1pC5GuJjuctRgsg42BWxcjnGfAgboeEas/view?usp=sharing',
    elementsPdf: '#',
  },
  {
    id: 'ehs-2',
    ...
    cataloguePdf: 'https://drive.google.com/file/d/1mj6wcYMfd_hjdmNsB57SC5QNLHm4nCkJ/view?usp=sharing',
    elementsPdf: '#',
  },
  {
    id: 'ehs-3',
    ...
    cataloguePdf: 'https://drive.google.com/file/d/1pZHA9dpmJ0Cw9k3UmVZgEJHEhxVGq13u/view?usp=sharing',
    elementsPdf: '#',
  },
  {
    id: 'ehs-4',
    ...
    cataloguePdf: 'https://drive.google.com/file/d/1Nr-O6qttUBVjusLzu-wwqpLZC6K04_dx/view?usp=sharing',
    elementsPdf: '#',
  },
  {
    id: 'ehs-5',
    ...
    cataloguePdf: 'https://drive.google.com/file/d/1_Vn8GZafooIIcJsiEyNsnZGYX8p0-fAR/view?usp=sharing',
    elementsPdf: '#',
  },
  // Product Testing
  {
    ...
    description: 'Purity testing ensures the chemical integrity, composition accuracy, and authenticity of raw materials and finished products. We use high-precision chromatographic and spectrometric techniques (HPLC, GC, UV-Vis) to deliver reliable purity profiling aligned with ISO and global regulatory standards.',
  ...
  },
  {
    ...
    category: 'Product Testing',
    description: 'We identify, quantify, and evaluate trace impurities, degradation products, and foreign contaminants using advanced instrumentation such as LC-MS/MS, GC-MS, and ICP-MS. Our profiling supports regulatory submissions, quality assurance, and risk assessment across pharmaceuticals, chemicals, and industrial products.',
  ...
  },
  {
    ...
    title: 'Pathogens',
    category: 'Product Testing',
    description: 'Our pathogen testing covers microbial analysis of food, water, surfaces, and consumer products. Using culture-based and molecular qPCR assays, we detect bacteria, viruses, fungi, and hygiene indicators to ensure product safety, contamination prevention, and regulatory compliance.',
  ...
  },
  {
    ...
    title: 'Toxins',
    category: 'Product Testing',
    description: 'We analyze harmful biological and chemical toxins including mycotoxins, solvent residues, heavy metals, and environmental contaminants. Our toxin screening supports safety validation, regulatory conformity, and end-user protection across diverse industries.',
    icon: <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m8.5 2.7 4 4.1 4-4.1M12 16.5V22"/><path d="M7 16.5h10"/><path d="M12 2.2c2.3 1.3 4.2 3.1 5.5 5.3m-11 0c1.3-2.2 3.2-4 5.5-5.3"/><path d="M4.2 11c-1.6.5-2.6 1.4-3 2.5 1.2 2.5 4 4 7.8 4s6.6-1.5 7.8-4c-.4-1.1-1.4-2-3-2.5"/><path d="M12 13.5V11c0-1-1-2-1-2h-1"/></svg>,
    cataloguePdf: '#',
    elementsPdf: '#',
  },
  {
    id: 'pt-5',
    title: 'Engine Oil Dilution Assessment',
    category: 'Product Testing',
    description: 'We provide precise engine oil dilution analysis using gas chromatography to measure fuel content in lubricants. This service is critical for performance tuning, engine health diagnostics, and validating lubricant integrity in automotive and industrial applications.',
  ...
  {
    id: 'pt-6',
    title: 'Advanced Exhaust Gas Analysis',
    category: 'Product Testing',
    description: 'Our lab performs comprehensive analysis of exhaust emissions, including NOx, SOx, CO, and particulate matter, using advanced gas analyzers. We support regulatory compliance, emissions control validation, and performance benchmarking for engine and vehicle manufacturers.',
    icon: <AreaChart className="h-8 w-8 text-secondary" />,
    cataloguePdf: '#',
    elementsPdf: '#',
  },
  {
    id: 'pt-7',
    title: 'Biodiesel & Fuel Blend Evaluation',
    category: 'Product Testing',
    description: 'We conduct detailed chemical analysis of biodiesel and alternative fuel blends to verify quality, stability, and compliance with national and international standards (e.g., ASTM, EN). Our services ensure fuel integrity for producers and fleet operators.',
    icon: <Recycle className="h-8 w-8 text-secondary" />,
    cataloguePdf: '#',
    elementsPdf: '#',
  },
  {
    id: 'pt-8',
    title: 'Custom Fuel Blending for RON Studies',
    category: 'Product Testing',
    description: 'We offer specialized fuel blending services to create custom formulations for Research Octane Number (RON) and Motor Octane Number (MON) studies. Our precision blending supports engine calibration, additive research, and performance fuel development.',
    icon: <FlaskRound className="h-8 w-8 text-secondary" />,
    cataloguePdf: '#',
    elementsPdf: '#',
  },
];
...
export const teamMembers: TeamMember[] = [
  {
    ...
    bio: 'Leads AnaTech’s technical strategy and laboratory excellence, overseeing complex environmental and OHS testing programs while ensuring methods stay at the cutting edge of regulatory and industry standards.',
    imageId: 'team-1',
  },
  {
    id: 'team-2',
    ...
    bio: 'Drives AnaTech’s brand, partnerships, and market growth by connecting our advanced testing capabilities with industry needs, shaping campaigns that highlight reliability, compliance, and end‑to‑end environmental solutions for clients.',
    imageId: 'team-2',
  },
  {
    id: 'team-3',
    name: 'PAVAN JOSEPH',
    role: 'Asst. Director Client Services',
    bio: 'Leads AnaTech’s day‑to‑day marketing execution, turning strategy into campaigns that generate qualified enquiries, strengthen client relationships, and showcase our environmental and OHS testing solutions across digital and B2B channels',
    imageId: 'team-3',
  },
  {
    id: 'team-4',
...
export const jobOpenings: JobOpening[] = [
  ...
  {
    id: 'job-4',
    title: 'IT Systems & Lab Technology Intern',
    location: 'Bangalore, India',
    type: 'Full-time',
    description: 'Support IT infrastructure, web systems, and laboratory software platforms. Ideal for candidates with basic knowledge of IT systems, databases, or web technologies and an interest in scientific or healthcare environments.',
  },
  {
    id: 'job-5',
    ...
    location: 'Bangalore, India',
    type: 'Full-time',
    description: 'Assist in driving business growth by identifying new clients and markets for our OHS, EMS, and testing services. Suitable for candidates with strong communication skills and interest in B2B sales and industrial services.',
  }
];
